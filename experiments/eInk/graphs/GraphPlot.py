...
class GraphPlot(Widget):
    ...
    def __init__(self,
        ...
        self.dry = NO_BITMAPTOOLS or dry
        self._width = width
        self._height = height
    ...
    def _plot_line(self, data_array: list):
        ...
        current_pixel_value_x = self.origin[0] if self.alignment != 'right' else self.top_right[0] - (len(data_array)
                                                                                                      - 1)
        for x_value in range(len(data_array) - 1):
            ...
            if self.alignment == 'fit':
                ...
                next_pixel_value_x = current_pixel_value_x + 1
